...
@implementation ZWYTableViewCell5
...
- (void)layoutSubviews {
    ...
    _nameLabel.frame = CGRectMake(210, 10, 200, 50);
    _authorLabel.frame =CGRectMake(310, 40, 80, 20);
    _noteLabel.frame = CGRectMake(220, 60, 130, 60);
